...
file_path = "Academic_Score_3.xlsx"
...
if original_missing_mask.sum() == 0:
    ...
    orig_df = pd.read_csv("original_data.csv")
    intro_df = pd.read_csv("data/intro_grades.csv")
    hw_df = pd.read_csv("data/handwriting_grades.csv")
    ...
    model = joblib.load("best_cgpa_model_v2.pkl")
