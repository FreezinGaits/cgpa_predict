"""
generate_visualizations.py — Generates 25+ publication-quality graphs + decision tables + exports final cleaned CSV
...
print(f'   Saved: CGPA Project/final_cleaned_dataset.csv ({len(csv_out)} rows, {csv_out.shape[1]} cols)')
...
# ── 1. CGPA Distribution (Original vs Imputed) ──
...
# ── 2. CGPA Distribution by Grade Category ──
fig, ax = plt.subplots(figsize=(10, 5))
...
# ── 17. Per-Fold Accuracy Bar Chart ──
fig, ax = plt.subplots(figsize=(10, 5))
...
# ── 18. Predicted vs Actual (CV Aggregated) ──
...
# ── 19. Predicted vs Actual (Holdout) ──
fig, ax = plt.subplots(figsize=(8, 8))
...
# ── 21. Confusion Matrix Heatmap (CV) ──
fig, ax = plt.subplots(figsize=(8, 6))
...
# ── 22. Confusion Matrix Heatmap (Holdout) ──
fig, ax = plt.subplots(figsize=(8, 6))
...
# ── 23. Missing Data Before Cleaning ──
...
# ── 24. Pairplot: Top 4 Features vs CGPA ──
...
# ── 25. Assignment vs Midterm colored by CGPA ──
...
# ── TABLE 1: Model Comparison Decision Table ──
...
# ── TABLE 2: Preprocessing Algorithm Comparison ──
...
# ── TABLE 3: Feature Statistics Summary ──
...
# ── TABLE 4: CV Fold-by-Fold Results ──
fig, ax = plt.subplots(figsize=(12, 5))
ax.axis('off')
table_data4 = []
for fd in fold_data:
...
# ── 30. Academic Score vs CGPA (Hexbin density) ──
fig, ax = plt.subplots(figsize=(10, 7))
...
print(f'Final cleaned CSV: CGPA Project/final_cleaned_dataset.csv')
